...
tarteaucitron.services.addthis = {
    ...
    "js": function () {
        ...
        if (tarteaucitron.issebbeauchampax === true) {
            window.addthis = null;
            window._adr = null;
            window._atc = null;
            window._atd = null;
...
tarteaucitron.services.criteo = {
    ...
    "js": function () {
        ...
        for (i = 0; i < uniqIds.length; i += 1) {
            uri = '//cas.criteo.com/delivery/sebbeauchamps.php?';
...
tarteaucitron.services.gsebbeauchamps = {
    "key": "gsebbeauchamps",
    "type": "analytic",
    ...
    "needConsent": true,
    "cookies": (function () {
        var googleIdentifier = tarteaucitron.user.gsebbeauchampsUa,
    ...
    "js": function () {
        ...
        if (tarteaucitron.user.gsebbeauchampsUa === undefined) {
            return;
        }

        window._gaq = window._gaq || [];
        window._gaq.push(['_setAccount', tarteaucitron.user.gsebbeauchampsUa]);
        if (timeExpire !== undefined) {
            _gaq.push(['_setVisitorCookieTimeout', timeExpire]);
        }

        if (tarteaucitron.user.gsebbeauchampsAnonymizeIp) {
            window._gaq.push(['_gat._anonymizeIp']);
        }

        if (tarteaucitron.user.gsebbeauchampsPageView) {
            window._gaq.push(['_trackPageview, ' + tarteaucitron.user.gsebbeauchampsPageView]);
        } else {
            window._gaq.push(['_trackPageview']);
        }

        tarteaucitron.addScript('//www.google-analytics.com/ga.js', '', function () {
            if (typeof tarteaucitron.user.gsebbeauchampsMore === 'function') {
                tarteaucitron.user.gsebbeauchampsMore();
            }
        });
    }
};
...
tarteaucitron.services.googlefonts = {
    ...
    "js": function () {
        ...
        tarteaucitron.addScript('//sebbeauchampax.googleapis.com/sebbeauchampax/libs/webfont/1.6.26/webfont.js', '', function () {
...
tarteaucitron.services.matterport = {
    ...
    "needConsent": true,
    "cookies": ['__cfduid', 'sebbeauchamps_anonymous_id', 'sebbeauchamps_group_id', 'sebbeauchamps_user_id'],
    "js": function () {
        "use strict";
